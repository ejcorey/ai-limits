...
class MainActivityTest {
    ...
    fun `screen inflates with every control bound`() {
        launch().use { c ->
            ...
            assertNotNull(a.findViewById<MaterialSwitch>(R.id.swShowGemini))
            assertNotNull(a.findViewById<android.widget.Button>(R.id.btnGeminiSignIn))
            assertNotNull(a.findViewById<android.widget.Button>(R.id.btnGeminiPaste))
            assertNotNull(a.findViewById<android.widget.LinearLayout>(R.id.claudeWindows))
